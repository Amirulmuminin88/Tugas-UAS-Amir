	...
	<div class="container">
		<div class="content">
			...
			if(isset($_POST['ganti'])){
				...
				$cek = mysqli_query($koneksi, "SELECT * FROM tbl_discord WHERE username='$username' AND password='$password'");
				if(mysqli_num_rows($cek) == 0){
					...
					if($password1 == $password2){
						if(strlen($password1) >= 4){
							$pass = md5($password1);
							$update = mysqli_query($koneksi, "UPDATE tbl_discord SET password='$pass' WHERE username='$username'");
							if($update){
