<?php $thisPage="Edit"; ?>
<?php $title = "Edit Profile - Spades Discord" ?>
		...
		<div class="content">
			...
			<form class="form-horizontal" action="" method="post">
				<div class="form-group">
					<label class="col-sm-3 control-label">ID Discord</label>
					<div class="col-sm-2">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="text" name="status" value="<?php echo $row ['status']; ?>" class="form-control" placeholder="Ststus" required>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-2">
						<select name="game" class="form-control" required>
							<option value="<?php echo $row['game']; ?>"> - Pilih Game - </option>
				...
				<div class="form-group">
					<label class="col-sm-3 control-label">Genre Game</label>
					<div class="col-sm-2">
						<select name="genre_game" class="form-control" required>
							<option value="<?php echo $row['fakultas']; ?>"> - Genre Game - </option>
                    ...
                    <div class="col-sm-3">
                    <b>Genre Game :</b> <span class="label label-success"><?php echo $row['genre_game']; ?></span>
				    </div>
				</div>
				<div class="form-group">
