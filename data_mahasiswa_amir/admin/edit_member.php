...
<?php $title = "Edit Data Mahasiswa - Spades Discord" ?>
<?php $description = "Edit Data MMahasiswa - Spades Discord" ?>
<?php 
include("header.php");
include("../koneksi.php");
?>
	<div class="container">
		<div class="content">
			...
			if(isset($_POST['save'])){
				...
				$update = mysqli_query($koneksi, "UPDATE tbl_discord SET username='$username', level='$level', nama='$nama', jenis_kelamin='$jenis_kelamin', tempat_lahir='$tempat_lahir', tanggal_lahir='$tanggal_lahir', alamat_asal='$alamat_asal', alamat_sekarang='$alamat_sekarang', no_telepon='$no_telepon', email='$email', status='$status', game='$game', genre_game='$genre_game' WHERE id_discord='$id_discord'") or die(mysqli_error());
				if($update){
					header("Location: edit_member.php?id_discord=".$id_discord."&pesan=sukses");
				}else{
			...
			<form class="form-horizontal" action="" method="post">
				...
				<div class="form-group">
                    ...
                    <!-- <div class="col-sm-3">
                    <b>Jurusan Sekarang :</b> <span class="label label-success"><?php echo $row['game']; ?></span>
				    </div> -->
				</div>
				<div class="form-group">
                    ...
                    <!-- <div class="col-sm-3">
                    <b>Fakultas Sekarang :</b> <span class="label label-success"><?php echo $row['genre_game']; ?></span>
				    </div> -->
				</div>
				<!--<div class="form-group">
					<label class="col-sm-3 control-label">Username</label>
